...
/*
 * A large Button, even with zero'd padding, is still a bit too large in
...
export default function CardTitleMenu({
  ...
  const buttonProps = {
    iconStart: <IconMoreHoriz title={actionsMessage} />,
    minimal: true
  };
